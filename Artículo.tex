...
\begin{thebibliography}{99}
  \bibitem{compilers-and-interpreters} \href{https://youtu.be/_C5AHaS1mOA}{Boiteau, D. (Escritor), \& Beecroft, S. (Director). (1983). Computer Languages (Temporada 1, Episodio 6) [Episodio de serie de televisión]. En M. McManus (Productor ejecutivo), \textit{Bits and Bytes}. TVOntario.}
